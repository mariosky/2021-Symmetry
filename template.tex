...
Algorithms (EAs) and other metaheuristics are often employed in tuning 
Fuzzy Inference Systems (FISs) % Define this. Is it Fuzzy inference systems? - JJ
\cite{martinez-soto_bio-inspired_2012,DBLP:conf/evoW/SalemMGG18}.

EAs are a population-based optimization metaheuristic that can be used, among
other things, for solving complex
...
are Genetic Algorithms (GAs) \cite{holland1992genetic} which use specific
representation for the problems to solve, as well as some specific operators:
surviving individuals reproduce through genetic crossover and mutation
...
Fuzzy PID Controller % Explain acronym too - JJ
